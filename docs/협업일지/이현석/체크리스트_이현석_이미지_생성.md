...
#### Day 3-5 (12/31-1/2): SDXL 모델 로드

**UnifiedImageGenerator 클래스 기본 구조**
- [ ] 파일 생성: 
- [ ] Import 구문
  ```python
  import torch
...
- [ ] 이미지 생성 클래스 정의
  ```python
  class ImageGenerator: # 이름은 의미가 전달되는 범위에서 임의로 지정
