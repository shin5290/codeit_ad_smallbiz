...
**파일 생성**
- [X] 파일 생성: `src/generation/text_generation/text_generator.py`
- [X] Import 구문
  ```python
  import os
...
**응답 품질 테스트**
- [X] 20자 이내 제약 확인
- [X] 톤 적합성 확인 (warm, professional 등)
- [X] 이모지 포함 여부 확인
- [X] 특수문자 처리 확인
...
**파일 생성**
- [X] 파일 생성: `src/generation/text_generation/prompt_manager.py`
- [X] Import 구문
  ```python
  import os
  from dotenv import load_dotenv
